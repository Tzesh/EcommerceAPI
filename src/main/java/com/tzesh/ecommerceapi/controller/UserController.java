...
public class UserController {
    ...
    @Operation(summary = "Delete a user by username - telephone configuration", description = "Delete a user by username - telephone configuration and return the user")
    public ResponseEntity<BaseResponse<UserDTO>> removeUser(@RequestBody @Valid RemoveUserRequest request) {
        // call the delete method in the user service
        UserDTO userDTO = userService.deleteUser(request);
